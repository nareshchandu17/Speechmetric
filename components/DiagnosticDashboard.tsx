        ...
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 items-start">
            ...
            <div className="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm flex flex-col justify-between space-y-4">
              <div>
                <div className="flex items-center justify-between border-b border-slate-100 pb-4 mb-2 relative">
                  <div>
                    <h3 className="text-base font-black tracking-tight text-slate-900 font-sans">
                ...
                <div className="p-5 bg-slate-50/60 rounded-2xl border border-slate-200/50 leading-relaxed text-sm text-slate-800 font-semibold flex flex-wrap gap-x-2 gap-y-2.5 min-h-[180px]">
          ...
          <div className="xl:col-span-5 space-y-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
              ...
              <div className="md:col-span-5 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 text-white rounded-3xl p-5 shadow-lg border border-blue-500/20 flex flex-col justify-between relative overflow-hidden h-48">
              ...
              <div className="md:col-span-7 grid grid-cols-1 gap-2">
                ...
                <div className="bg-white rounded-2xl border border-slate-200/60 p-3 flex flex-col justify-between shadow-sm h-[60px] relative overflow-hidden">
                  <div className="flex items-center justify-between">
            ...
            <div className="bg-blue-50/50 border border-blue-100/50 rounded-3xl p-5 shadow-sm flex items-center justify-between gap-4">
                  ...
                  <div>
                    <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                      <div className="flex items-baseline gap-1.5">
                        ...
                        <h4 className="text-lg font-black tracking-tight text-slate-900 font-sans">
                          &quot;{selectedWord.word}&quot;
                        </h4>
                      </div>
                    ...
                    <div className="mt-4">
                      ...
                      <div className="bg-slate-50/50 rounded-2xl border border-slate-200/60 p-4 relative overflow-hidden flex items-center justify-center">
                  ...
                  <div className="space-y-2 pt-4 border-t border-slate-100 mt-4">
                    <div className="flex gap-2">
                      <button
                        ...
                        className="flex-1 py-2 bg-slate-100 hover:bg-slate-200 border border-slate-200 rounded-xl text-xs font-semibold text-slate-700 flex items-center justify-center gap-1.5 transition-all duration-150 cursor-pointer active:scale-95"
                      >
                      ...
                      <button
                        ...
                        className="flex-1 py-2 bg-emerald-50 hover:bg-emerald-100 border border-emerald-200 rounded-xl text-xs font-bold text-emerald-800 flex items-center justify-center gap-1.5 transition-all duration-150 cursor-pointer active:scale-95"
                      >
        ...
        <div className="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm">
          <div className="border-b border-slate-100 pb-4 mb-4 flex items-center justify-between">
            ...
            <button
              ...
              className="px-3.5 py-1.5 bg-blue-50 hover:bg-blue-100 text-blue-700 rounded-xl text-xs font-bold flex items-center gap-1.5 transition-all cursor-pointer active:scale-95"
            >
              <Volume2 className="w-3.5 h-3.5" />
              Listen to Audio
            </button>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            {drills.map((drill, idx) => (
              <div
                key={drill.id}
                className="p-5 rounded-2xl bg-slate-50/50 border border-slate-200/60 flex flex-col justify-between hover:border-slate-300 transition-all shadow-sm"
              >
                <div>
                  <div className="flex items-center gap-2">
                ...
                <div className="mt-5">
                  <button
                    ...
                    className="px-4 py-2 bg-white hover:bg-slate-100 border border-slate-200 rounded-xl text-xs font-bold text-slate-800 flex items-center justify-center gap-1.5 transition-all duration-150 cursor-pointer active:scale-95"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-3 space-y-4">
                <div>
                  ...
                  <ul className="list-disc pl-4 text-xs text-slate-600 mt-2 space-y-1 font-semibold leading-relaxed">
          ...
          <div className="bg-white rounded-3xl border border-slate-200/60 p-6 shadow-sm flex flex-col justify-between space-y-4">
            <div>
              ...
              <p className="text-xs text-slate-600 leading-relaxed mt-2.5 font-semibold">
                {session.feedback.intelligibilityExplanation}
              </p>
            </div>

            <div className="p-4 bg-slate-900 text-white rounded-2xl border border-slate-800">
              <h5 className="text-xs font-bold font-mono text-emerald-400 uppercase tracking-wider">
                coaching feedback
              </h5>
